...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<a href="https://traveltriangle.com/blog/temples-in-odisha/" target="_blank"><img src="admin/pacakgeimages/<?php echo htmlentities($result->PackageImage);?>" class="img-responsive" alt=""></a>
			<?php } else {?>
